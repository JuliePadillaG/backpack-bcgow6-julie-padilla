...
type Service interface {
	...
	CreateProduct(name, color string, price float64, stock int, code string, published bool, creationDate string) (Product, error)
	UpdateProduct(id int, name, color string, price float64, stock int, code string, published bool, creationDate string) (Product, error)
	Delete(id int) error
...
func (s *service) CreateProduct(name, colour string, price float64, stock int, code string, published bool, creationDate string) (Product, error) {
...
func (s *service) UpdateProduct(id int, name, colour string, price float64, stock int, code string, published bool, creationDate string) (Product, error) {
